...
> Avant de débuter votre analyse, ajoutez dans le code SciViews lié à l'AFM mis à votre disposition dans le bookdown : <http://biodatascience-course.sciviews.org/sdd-umons2/analyse-factorielle-multiple-afm.html>
...
> Si vos tableaux comprennent une colonne relative au station, transformez cette dernière en nom des lignes avec la fonction `column_to_rownames()`. Vous pouvez également prendre la décision de supprimer cette colonne.
...
> Nous allons débuter par réaliser 3 groupes dans nos données : le groupe lié à la communauté de poisson, le groupe lié à la géogrpahie et le groupe lié à la qualité de l'eau. Utilisez le nom et la signification des variables pour définir vos trois groupes.
